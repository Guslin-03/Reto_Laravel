...
<head>
    ...
    <title>{{ config('app.name', 'Ibermaniáticos') }}</title>
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('app.name', 'Ibermaniáticos') }}
                </a>
                <button id="collapsed-navbar" class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="{{ __('Toggle navigation') }}">
        ...
        <div id="img-darkMode" class="dropdown position-fixed bottom-0 end-0 mb-3 me-3 bd-mode-toggle">
